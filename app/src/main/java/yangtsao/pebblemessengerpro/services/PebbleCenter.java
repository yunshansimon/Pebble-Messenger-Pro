...
public class PebbleCenter extends Service {
    ...
    private static final byte REMOTE_DISPLAY_MESSAGE_TABLE=4;
    private static final byte REMOTE_DISPLAY_CALL_TABLE=5;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case PEBBLE_SEND_MESSAGE: {
                    waitQueue.add((PebbleMessage) msg.getData().getSerializable(MessageDbHandler.COL_MESSAGE_CONTENT));
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case PREPARE_MESSAGE:{
                    ...
                    split_to_packages_add_to_sendQue(pages);
    ...
    private void split_to_packages_add_to_sendQue(List<PebbleMessage> listPM){
            ...
            switch (msg.what){
                case SEND_MESSAGE:
                    ...
                    if (appStatue==0){
                        ...
                        this.postDelayed(sendToPebble,2000);
                    }else {
                ...
                case SEND_CALL_END:
                    ...
                    break;
                case SEND_CLOSE_APP:
                    this.postDelayed(closeApp,3000);
                    break;
            }
    ...
    Runnable sendToPebble=new Runnable() {
        ...
        public void run() {
            ...
            if(tmpPD.getInteger(ID_COMMAND)==REMOTE_EXCUTE_CONTINUE_MESSAGE) {
